...
public class CircleImageView extends ImageView
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		if (mShowFlag && mFlagText != null)
		{
			...
			canvas.drawText(mFlagText, getWidth() / 2, (3 + (float)Math.cos(Math.PI * 5 / 18)) * getHeight() / 4 + mFlagTextBounds.height() / 3, mFlagTextPaint);
		}
	...
	private void setup()
	{
		...
		mSweepGradient = new SweepGradient(getWidth() / 2, getHeight() / 2, new int[]
				{ Color.rgb(255, 255, 255), Color.rgb(1, 209, 255) }, null);
