...
public class CommonTextView extends RelativeLayout {
    ...
    private int defaultDividerLineColor = 0xFFE5E5E5;//分割线默认颜色
...
//    private RelativeLayout.LayoutParams rightIVParams;
    ...
    public CommonTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        defaultPadding = dip2px(context, 15);
...
//            textView.setGravity(Gravity.CENTER);
    ...
    public TextView getLeftTopTextView() {
        return leftTopTextView != null ? leftTopTextView : null;
    }
    ...
    public TextView getLeftBottomTextView() {
        return rightBottomTextView != null ? rightBottomTextView : null;
    }
    ...
    public TextView getLeftTextView() {
        return leftTextView != null ? leftTextView : null;
    }
    ...
    public TextView getCenterTextView() {
        return centerTextView != null ? centerTextView : null;
    }
    ...
    public TextView getRightTopTextView() {
        return rightTopTextView != null ? rightTopTextView : null;
    }
