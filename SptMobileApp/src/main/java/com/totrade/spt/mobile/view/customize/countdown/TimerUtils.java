package com.totrade.spt.mobile.view.customize.countdown;
...
public class TimerUtils {
    ...
    public static final String TIME_STYLE_TWO = "HH小时mm分ss秒";
    public static final String TIME_STYLE_THREE = "dd天HH小时mm分ss秒";
    public static final String TIME_STYLE_FOUR = "dd天HH小时mm分";
