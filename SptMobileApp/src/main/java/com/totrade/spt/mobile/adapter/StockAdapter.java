 ...
 */
public class StockAdapter extends RecyclerAdapterBase<MyStockDownEntity, StockAdapter.ViewHolder> {


    private int selectPosition = -1;//用来记录选中项的位置
    private MyStockDownEntity selectOjb;//记录选中的对象
     ...
     * @param selectOjb
     */
    public void setSelectOjb(MyStockDownEntity selectOjb) {
        this.selectOjb = selectOjb;
    }

    @Override
    public StockAdapter.ViewHolder createViewHolderUseData(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_trade_order3, parent, false));
    }
