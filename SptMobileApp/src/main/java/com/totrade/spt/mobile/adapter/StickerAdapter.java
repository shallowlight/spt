...
import com.totrade.spt.mobile.view.customize.StickerCategory;
import com.totrade.spt.mobile.view.customize.StickerItem;
import com.totrade.spt.mobile.view.im.emoj.EmoticonView;
import com.totrade.spt.mobile.view.im.emoj.StickerManager;
...
public class StickerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageLoader.getInstance().displayImage(StickerManager.getInstance().getStickerBitmapUri(sticker.getCategory()
                , sticker.getName()), viewHolder.imageView, StickerManager.getInstance().getStickerImageOptions(FormatUtil.dip2px(context,64)));
